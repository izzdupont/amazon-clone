...
function Payment() {
    ...
    useInsertionEffect(() =>
    {
        // generate the special stripe secret which allows us to charge a customer acertain amount
        //whenever value change it will generate new num
